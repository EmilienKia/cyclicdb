...
/*
 * src/client/cyclicdb-client-http.cpp
...
cyclic::proto::expected<cyclic::proto::timeseries_data> cyclic_http_client::get_timeseries_data(const std::string& dbname, const std::string& tsname, std::optional<cyclic::record_index_t> start, std::optional<cyclic::record_index_t> end, std::optional<cyclic::record_index_t> count) {
