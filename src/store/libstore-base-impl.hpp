...
/*
 * src/store/libstore-base-impl.hpp
...
/**
 * Base of simple implementation of recordset
 */
class base_recordset_impl : public recordset
{
protected:
...
public:
    /** Default constructor. */
    base_recordset_impl() = default;
    /** Destructor. */
    virtual ~base_recordset_impl() = default;
    ...
    public:
        iterator() = default;
        iterator(const base_recordset_impl* recset, record_index_t index = record::invalid_index());
    ...
    protected:
        ...
        const base_recordset_impl* _recordset = nullptr;
...
public:
    ...
    /** Destructor. */
    virtual ~base_table_impl() = default;
